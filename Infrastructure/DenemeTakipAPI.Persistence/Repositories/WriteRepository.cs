...
namespace DenemeTakipAPI.Persistence.Repositories
{
    public class WriteRepository<T> : IWriteRepository<T> where T : BaseEntity
    {
        readonly private denemeTakipAPIDbContext _context;
        public WriteRepository(denemeTakipAPIDbContext context)
        {
            _context = context;
        }
